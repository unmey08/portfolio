...
const SocialLinks = ({theme}) => {
  return (
    <div className={`hidden md:fixed top-1/3 left-0 duration-400 dark:bg-slate-800/95 rounded-lg md:flex border-solid bg-blue-300/20 flex-col text-3xl py-10 px-2`}>
