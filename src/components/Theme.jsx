...
const Theme = () => {
    ...
    return (
        <div className={`hidden md:fixed top-8 right-10 duration-400 dark:bg-slate-800 bg-transparent rounded-lg md:flex border-solid border ${pathname === '/' ? 'border-black' : darkMode ? 'border-white' : 'border-black'}`}>
            {
