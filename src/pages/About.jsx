  ...
  return (
    <AnimatedPage>
      <section className="w-full h-full dark:h-full max-container">
        ...
        >
          <p>
            I'm a Full-stack Developer based in Vancouver, Canada with 5+ years
            of experience building impactful web applications across borders in
            an Agile framework. Expertise in React, Redux, and TypeScript to
            create user-centric and efficient UIs.
          </p>
        </motion.div>
        ...
        <div className="py-16">
          ...
          <div className="mt-5 flex flex-col gap-3 text-slate-500 dark:text-gray-200">
            <p>
              I've worked with cross-functional teams across diverse locations
              (US and India) to deliver solutions that empower businesses.
              Here's the rundown:
            </p>
          </div>
              ...
              {experiences.map((experience) => (
                <VerticalTimelineElement
                  ...
                  contentArrowStyle={{
                    borderRight: `${
                      theme === "dark"
                        ? `7px solid ${experience.iconDarkBg}`
                        : "7px solid #ffffffaa"
                    }`,
                  }}
                >
                  ...
                  <ul className="my-5 list-disc ml-5 space-y-2">
                    {experience.points.map((point, index) => (
                      <li
                        className="text-black-500/70 dark:text-slate-400 font-normal "
